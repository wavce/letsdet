...
def bottle2neck(inputs,
    ...
    if scale != 1 and stype == "normal":
        ...
        sp_ = spx[num_convs]
        if strides != 1:
            sp_ = tf.keras.layers.ZeroPadding2D(((1, 1), (1, 1)), data_format, name=name + "/pad")(sp_)
            padding = "valid"
    ...
    shortcut = inputs
    if downsample:
        shortcut = tf.keras.layers.AvgPool2D(strides, strides, "same", data_format, name=name + "/downsample/avgpool")(shortcut)
    ...
    #         shortcut = self.downsample_pool(shortcut)
...
@BACKBONES.register("Res2NetV1B50V1B_26W4S")
...
@BACKBONES.register("Res2NetV1B101V1B_26W4S")
...
@BACKBONES.register("Res2NetV1B50V1B_26W6S")
...
@BACKBONES.register("Res2NetV1B50V1B_26W8S")
...
@BACKBONES.register("Res2NetV1B50V1B_48W2S")
...
@BACKBONES.register("Res2NetV1B50V1B_14W8S")
...
def _get_weight_name_map(blocks, scale):
    name_map = {
        "conv1/0/conv2d/kernel:0": "conv1.0.weight",
        "conv1/0/batch_norm/gamma:0": "conv1.1.weight",
        "conv1/0/batch_norm/beta:0": "conv1.1.bias",
        "conv1/0/batch_norm/moving_mean:0": "conv1.1.running_mean",
        "conv1/0/batch_norm/moving_variance:0": "conv1.1.running_var",
        "conv1/1/conv2d/kernel:0": "conv1.3.weight",
        "conv1/1/batch_norm/gamma:0": "conv1.4.weight",
        "conv1/1/batch_norm/beta:0": "conv1.4.bias",
        "conv1/1/batch_norm/moving_mean:0": "conv1.4.running_mean",
        "conv1/1/batch_norm/moving_variance:0": "conv1.4.running_var",
        "conv1/2/conv2d/kernel:0": "conv1.6.weight",
        "conv1/2/batch_norm/gamma:0": "bn1.weight",
        "conv1/2/batch_norm/beta:0": "bn1.bias",
        "conv1/2/batch_norm/moving_mean:0": "bn1.running_mean",
        "conv1/2/batch_norm/moving_variance:0": "bn1.running_var"
    }
